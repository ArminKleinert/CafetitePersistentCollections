...
class ListPair<T> private constructor(val left: PersistentList<T>, val right: PersistentList<T>) :
    ...
    class ConsPairIterator<T>(private val leftIterator: Iterator<T>, private val rightIterator: Iterator<T>) :
        Iterator<T> {
    ...
    override fun isLazyType(): Boolean = left.isLazyType() || right.isLazyType()
