...
class ListPairTest {
    ...
    @Test
    fun concat() {
        Assertions.assertInstanceOf(PersistentList::class.java, PersistentList.concat(of(listOf(1, 2), listOf(3, 4)), plOf()))
        Assertions.assertInstanceOf(PersistentList::class.java, PersistentList.concat(of(listOf(1, 2), listOf(3, 4)), plOf(5, 6)))
        Assertions.assertInstanceOf(PersistentList::class.java, PersistentList.concat(plOf(), of(listOf(5, 6), listOf(7, 8))))
        Assertions.assertInstanceOf(PersistentList::class.java, PersistentList.concat(plOf(1, 2), of(listOf(3, 4), listOf(5, 6))))
        Assertions.assertInstanceOf(PersistentList::class.java, PersistentList.concat(of(listOf(1), listOf(2, 3)), of(listOf(4), listOf(6))))
    ...
    @Test
    fun dropWhile() {
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(4, 6, 7, 8)).dropWhile { it > 0 })
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(4, 6, 7, 8)).dropWhile { it < 0 })
    ...
    @Test
    fun filterIndexed() {
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(1, 2, 3)).filterIndexed { _, _ -> true })
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(1, 2, 3)).filterIndexed { _, _ -> false })
        Assertions.assertEquals(
            plOf(1, 2, 3, 1, 2, 3),
    ...
    fun filterNot() {
        ...
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(1, 2, 3)).filterNot { false })
    ...
    @Test
    fun filtervNot() {
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(1, 2, 3)).filtervNot { true })
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(1, 2, 3)).filtervNot { false })
        ...
        fun foldRight() {
            ...
            Assertions.assertEquals(listOf(1, 2), of(listOf(listOf(1)), listOf(listOf(2))).foldRight(listOf(), List<Int>::plus))
            Assertions.assertEquals(listOf(1, 2, 0), of(listOf(listOf(1)), listOf(listOf(2))).foldRight(listOf(0), List<Int>::plus))
        }
    ...
    @Test
    fun mapIndexed() {
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(4, 5)).mapIndexed { _, e -> e })
    ...
    fun mapIndexedNotNull() {
        Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3), listOf(4, 5)).mapIndexedNotNull { _, e -> e })
        ...
        Assertions.assertEquals(plOf(1, 3, 5),
    ...
    fun mapNotNull() {
        ...
        fun onEachIndexed() {
            ...
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2), listOf(3, 4)).onEachIndexed {i,e->e+i})
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2), listOf(3, 4)).onEachIndexed { _, _ ->})
    ...
    fun plus() {
        ...
        fun requireNoNulls() {
            ...
            Assertions.assertThrows(IllegalArgumentException::class.java) { of(listOf(null, null), listOf(3, 4)).requireNoNulls() }
            Assertions.assertThrows(IllegalArgumentException::class.java) { of(listOf(1, 2), listOf(null, null)).requireNoNulls() }
            Assertions.assertThrows(IllegalArgumentException::class.java) { of(listOf(null, 2), listOf(null, 4)).requireNoNulls() }
        ...
        @Test
        fun runningFold() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).runningFold(0) { acc, it -> acc + it })
            ...
            Assertions.assertEquals(plOf("", "a", "ab"), of(listOf("a"),listOf("b")).runningFold("") { acc, it -> acc + it })
        }

        @Test
        fun runningFoldIndexed() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).runningFoldIndexed(0) { _, acc, it -> acc + it })
            Assertions.assertEquals(plOf(0, 0, 0, 0), of(listOf(1), listOf(2, 3)).runningFoldIndexed(0) { _, acc, _ -> acc })
            Assertions.assertEquals(plOf(0, 1, 3, 6), of(listOf(1), listOf(2, 3)).runningFoldIndexed(0) { _, acc, it -> acc + it })
            Assertions.assertEquals(plOf("", "a", "ab"), of(listOf("a"),listOf("b")).runningFoldIndexed("") { _, acc, it -> acc + it })
        }

        @Test
        fun runningReduce() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).runningReduce { acc, it -> acc + it })
        ...
        fun runningReduceIndexed() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).runningReduceIndexed { _, acc, it -> acc + it })
            Assertions.assertEquals(plOf(1, 1, 1), of(listOf(1), listOf(2, 3)).runningReduceIndexed { _, acc, _ -> acc })
            Assertions.assertEquals(plOf(1, 3, 6), of(listOf(1), listOf(2, 3)).runningReduceIndexed { _, acc, it -> acc + it })
            Assertions.assertEquals(plOf("a", "ab"), of(listOf("a"),listOf("b")).runningReduceIndexed { _, acc, it -> acc + it })
        }

        @Test
        fun scan() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).scan(0) { acc, it -> acc + it })
            Assertions.assertEquals(plOf("d", "d", "d", "d"), of(listOf("a"),listOf( "b", "c")).scan("d") { acc, _ -> acc })
            Assertions.assertEquals(plOf("d", "da", "dab", "dabc"), of(listOf("a"),listOf( "b", "c")).scan("d") { acc, it -> acc + it })
        }

        @Test
        fun scanIndexed() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).scanIndexed(0) { _, acc, it -> acc + it })
            Assertions.assertEquals(plOf("d", "d", "d", "d"), of(listOf("a"),listOf( "b", "c")).scanIndexed("d") { _, acc, _ -> acc })
            Assertions.assertEquals(
                plOf("d", "da", "dab", "dabc"),
    ...
    fun shuffled() {
        ...
        @Test
        fun sortedWith() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(3), listOf(2, 1)).sortedWith { a, b -> a.compareTo(b) })
        ...
        @Test
        fun subList() {
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1, 2, 3, 4, 5, 6), listOf(7, 8, 9, 10)).subList(3, 6))
        ...
        fun takeWhile() {
            ...
            Assertions.assertEquals(plOf(1,2), of(listOf(1), listOf(2)).takeWhile { true })
            Assertions.assertEquals(plOf(0, 1, 2, 3, 4), of(listOf(0, 1, 2, 3, 4, 5, 6), listOf(7, 8, 9)).takeWhile { it < 5 })
        }
    ...
    fun toMutableList() {
        ...
        fun zip() {
            ...
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).zip(of(listOf(4), listOf(5, 6))))
            ...
            Assertions.assertEquals(plOf(1 to 4, 2 to 5, 3 to 6), of(listOf(1), listOf(2, 3)).zip(of(listOf(4), listOf(5, 6))))

            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).zip(plOf<Int>()) { a, b -> a + b })
            Assertions.assertInstanceOf(PersistentList::class.java, of(listOf(1), listOf(2, 3)).zip(of(listOf(4), listOf(5, 6))) { a, b -> a + b })
