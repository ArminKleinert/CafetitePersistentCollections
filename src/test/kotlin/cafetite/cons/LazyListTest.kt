...
class LazyListTest {
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> from(coll:Array<T>) = LazyList.from(coll)
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> from(coll:Iterable<T>) = LazyList.from(coll)
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> from(coll:Collection<T>) = LazyList.from(coll)
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> of(vararg xs:T) = LazyList.of(*xs)
