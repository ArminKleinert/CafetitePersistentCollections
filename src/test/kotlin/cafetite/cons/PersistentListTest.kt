...
class PersistentListTest {
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> from(coll:Array<T>) = PersistentList.from(coll)
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> from(coll:Iterable<T>) = PersistentList.from(coll)
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> from(coll:Collection<T>) = PersistentList.from(coll)
    @Suppress("NOTHING_TO_INLINE") private inline fun <T> of(vararg xs:T) = PersistentList.of(*xs)
...
@Test fun of() {
        Assertions.assertEquals(PersistentList.of<Int>(), PersistentList.of<Int>())
        Assertions.assertEquals(PersistentList.of(1,2,3), PersistentList.of(1,2,3))    }
@Test fun testFrom() {
        Assertions.assertEquals(from<Int>(listOf()), from<Int>(listOf()))
        Assertions.assertEquals(from(listOf(1, 2, 3)), from(listOf(1, 2, 3)))
        Assertions.assertEquals(plOf<Int>(), from<Int>(listOf()))
        Assertions.assertEquals(plOf(1, 2, 3), from(listOf(1, 2, 3)))

        Assertions.assertEquals(from<Int>(listOf()), from(listOf<Int>().asIterable()))
        Assertions.assertEquals(from(listOf(1, 2, 3)), from(listOf(1, 2, 3).asIterable()))
        ...
        Assertions.assertEquals(from<Int>(listOf()), from(arrayOf<Int>()))
        Assertions.assertEquals(from(listOf(1, 2, 3)), from(arrayOf(1, 2, 3)))
...
@Test fun isLazyType() {
    Assertions.assertEquals(false, of<Int>().isLazyType())}
