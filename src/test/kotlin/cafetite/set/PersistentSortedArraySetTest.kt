...
class PersistentSortedArraySetTest {
    ...
    fun conjAll() {
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).conjAll(setOf(2, 4))))

        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).conjAll(listOf())))
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).conjAll(listOf(2, 4))))
    }

    @Test
    fun withoutAll() {
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).withoutAll(setOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).withoutAll(setOf())))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).withoutAll(setOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).withoutAll(setOf(1))))
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).withoutAll(setOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).withoutAll(setOf(4, 5, 6))))

        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).withoutAll(listOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).withoutAll(listOf())))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).withoutAll(listOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).withoutAll(listOf(1))))
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).withoutAll(listOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).withoutAll(listOf(4, 5, 6))))
    }
    ...
    fun conj() {
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).conj(2).conj(4)))
    }
    ...
    fun without() {
        ...
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).without(2).without(4)))
    ...
    fun plusSingle() {
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).plus(2).plus(4)))
    }
    ...
    fun plusMulti() {
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).plus(setOf(2, 4))))
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).plus(listOf(2, 4))))
    }
    ...
    fun minusSingle() {
        ...
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).minus(2).minus(4)))
    ...
    fun minusMulti() {
        ...
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).minus(setOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).minus(setOf(4, 5, 6))))
        ...
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).minus(listOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).minus(listOf(4, 5, 6))))
    }
    ...
    fun union() {
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).union(setOf(2, 4))))
        ...
        Assertions.assertEquals(setOf(1, 2, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).union(listOf(2, 4))))
    }

    @Test
    fun intersection() {
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).intersection(setOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).intersection(setOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).intersection(setOf(1))))
        Assertions.assertEquals(setOf(2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).intersection(setOf(2, 3, 4))))
    }
    ...
    fun and() {
        ...
        Assertions.assertEquals(setOf(2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).and(setOf(2, 3, 4))))
    }

    @Test
    fun difference() {
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).difference(setOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).difference(setOf())))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).difference(setOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).difference(setOf(1))))
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).difference(setOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).difference(setOf(4, 5, 6))))

        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).difference(listOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).difference(listOf())))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).difference(listOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).difference(listOf(1))))
        Assertions.assertEquals(setOf(1, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).difference(listOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).difference(listOf(4, 5, 6))))
    }

    @Test
    fun symmetricDifference() {
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).symmetricDifference(setOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).symmetricDifference(setOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).symmetricDifference(setOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).symmetricDifference(setOf(1))))
        Assertions.assertEquals(setOf(1, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).symmetricDifference(setOf(2, 4))))
        Assertions.assertEquals(
            setOf(1, 2, 3, 4, 5, 6),
            (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).symmetricDifference(setOf(4, 5, 6)))
        )

        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).symmetricDifference(listOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf(1), Int::compareTo).symmetricDifference(listOf())))
        Assertions.assertEquals(setOf(1), (PersistentSortedArraySet(setOf<Int>(), Int::compareTo).symmetricDifference(listOf(1))))
        Assertions.assertEquals(setOf<Int>(), (PersistentSortedArraySet(setOf(1), Int::compareTo).symmetricDifference(listOf(1))))
        Assertions.assertEquals(setOf(1, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).symmetricDifference(listOf(2, 4))))
        Assertions.assertEquals(
            setOf(1, 2, 3, 4, 5, 6),
    ...
    fun xor() {
        ...
        Assertions.assertEquals(setOf(1, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).xor(setOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3, 4, 5, 6), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).xor(setOf(4, 5, 6))))
        ...
        Assertions.assertEquals(setOf(1, 3, 4), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).xor(listOf(2, 4))))
        Assertions.assertEquals(setOf(1, 2, 3, 4, 5, 6), (PersistentSortedArraySet(setOf(1, 2, 3), Int::compareTo).xor(listOf(4, 5, 6))))
    }
    ...
    fun testEquals() {
        ...
        Assertions.assertEquals(PersistentSortedArraySet(setOf(1, 2, 3, 4, 5, 6), Int::compareTo), setOf(1, 2, 3, 4, 5, 6))
        ...
        Assertions.assertNotEquals(PersistentSortedArraySet(setOf(1, 2, 3, 4, 5, 6), Int::compareTo), setOf(1, 2, 3, 4, 5, 6, 7))
