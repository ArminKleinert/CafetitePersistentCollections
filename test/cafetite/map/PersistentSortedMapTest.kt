...
class PersistentSortedMapTest {
    ...
    fun getEntries() {
        Assertions.assertEquals(
            mapOf<Int, Int>().entries,
            PersistentSortedMap(mapOf<Int, Int>(), Int::compareTo).entries
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4).entries,
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).entries
        )
    }
    ...
    fun getValues() {
        ...
        Assertions.assertEquals(
            listOf(2, 3, 4),
            PersistentSortedMap(mapOf(1 to 2, 2 to 3, 3 to 4), Int::compareTo).values
        )
        Assertions.assertEquals(
            listOf(2, 2, 2),
            PersistentSortedMap(mapOf(1 to 2, 2 to 2, 3 to 2), Int::compareTo).values
        )
    }
    ...
    fun selectKeys() {
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap(mapOf<Int, Int>(), Int::compareTo).selectKeys(setOf(1, 2, 3))
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 2 to 3),
            PersistentSortedMap(mapOf(1 to 2, 2 to 3), Int::compareTo).selectKeys(setOf(1, 2))
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 2 to 3),
            PersistentSortedMap(mapOf(1 to 2, 2 to 3, 3 to 4), Int::compareTo).selectKeys(setOf(1, 2))
        )
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap(mapOf(1 to 2, 2 to 3, 3 to 4), Int::compareTo).selectKeys(setOf(1, 4))
        )
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap(mapOf(1 to 2, 2 to 3), Int::compareTo).selectKeys(setOf(3, 4))
        )
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap(mapOf(1 to 2, 2 to 3), Int::compareTo).selectKeys(setOf())
        )
    }
    ...
    fun getOrDefault() {
        ...
        Assertions.assertEquals(
            2,
            PersistentSortedMap(mapOf(1 to 2, 2 to 3, 3 to 4), Int::compareTo).getOrDefault(1, 88)
        )
        Assertions.assertEquals(
            88,
            PersistentSortedMap(mapOf(1 to 2, 2 to 3, 3 to 4), Int::compareTo).getOrDefault(7, 88)
        )
    }
    ...
    fun assocAll() {
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap<Int, Int>(mapOf(), Int::compareTo).assocAll(listOf(1 to 2))
        )
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap(mapOf(1 to 2), Int::compareTo).assocAll(listOf(1 to 2))
        )
        Assertions.assertEquals(
        ...
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap<Int, Int>(mapOf(), Int::compareTo).assocAll(mapOf(1 to 2))
        )
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap(mapOf(1 to 2), Int::compareTo).assocAll(mapOf(1 to 2))
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 2 to 3, 3 to 4),
    ...
    fun dissocAll() {
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap<Int, Int>(mapOf(), Int::compareTo).dissocAll(listOf(1))
        )
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap(mapOf(1 to 2), Int::compareTo).dissocAll(listOf(1))
        )
        Assertions.assertEquals(
            mapOf(3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).dissocAll(listOf(1, 4))
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).dissocAll(listOf(4))
        )
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).dissocAll(listOf(3))
        )
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).dissocAll(listOf(1, 2, 3))
        )
    }
    ...
    fun plusMulti() {
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap<Int, Int>(mapOf(), Int::compareTo).plus(listOf(1 to 2))
        )
        ...
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap<Int, Int>(mapOf(), Int::compareTo).plus(mapOf(1 to 2))
        )
    ...
    fun dissoc() {
        ...
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).dissoc(5)
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).dissoc(4)
        )
    ...
    fun minusSingle() {
        ...
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).minus(5)
        )
        Assertions.assertEquals(
            mapOf(3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).minus(1).minus(4)
        )
    ...
    fun minusMulti() {
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap<Int, Int>(mapOf(), Int::compareTo).minus(listOf(1))
        )
        Assertions.assertEquals(mapOf<Int, Int>(), PersistentSortedMap(mapOf(1 to 2), Int::compareTo).minus(listOf(1)))
        Assertions.assertEquals(
            mapOf(3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).minus(listOf(1, 4))
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).minus(listOf(4))
        )
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).minus(listOf(3))
        )
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap(mapOf(1 to 2, 3 to 4), Int::compareTo).minus(listOf(1, 2, 3))
        )
    }
    ...
    fun selectKeysWithoutComparator() {
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap.from(mapOf<Int, Int>()).selectKeys(setOf(1, 2, 3))
        )
        Assertions.assertEquals(
            mapOf(1 to 2, 2 to 3),
            PersistentSortedMap.from(mapOf(1 to 2, 2 to 3)).selectKeys(setOf(1, 2))
        )
        Assertions.assertEquals(
        ...
        Assertions.assertEquals(
            mapOf(1 to 2),
            PersistentSortedMap.from(mapOf(1 to 2, 2 to 3, 3 to 4)).selectKeys(setOf(1, 4))
        )
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap.from(mapOf(1 to 2, 2 to 3)).selectKeys(setOf(3, 4))
        )
    ...
    fun dissocAllWithoutComparator() {
        ...
        Assertions.assertEquals(
            mapOf(1 to 2, 3 to 4),
            PersistentSortedMap.from(mapOf(1 to 2, 3 to 4)).dissocAll(listOf(4))
        )
        Assertions.assertEquals(mapOf(1 to 2), PersistentSortedMap.from(mapOf(1 to 2, 3 to 4)).dissocAll(listOf(3)))
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap.from(mapOf(1 to 2, 3 to 4)).dissocAll(listOf(1, 2, 3))
        )
    }
    ...
    fun minusMultiWithoutComparator() {
        ...
        Assertions.assertEquals(
            mapOf<Int, Int>(),
            PersistentSortedMap.from(mapOf(1 to 2, 3 to 4)).minus(listOf(1, 2, 3))
        )
    }
